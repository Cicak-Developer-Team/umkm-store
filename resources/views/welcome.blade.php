        ...
        <div class="container">
            <div class="row g-4 mb-4">
                <div class="col-md-4">
                    ...
                    <p class="text-muted small">Platform e-commerce yang didedikasikan untuk memajukan produk-produk UMKM lokal Indonesia.</p>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled text-muted small">
                        <li><a href="#" class="text-decoration-none text-muted">Cara Pembelian</a></li>
                ...
                <div class="col-md-3">
                    ...
                    <p class="text-muted small mb-1"><i class="bi bi-envelope me-2"></i>support@umkmstore.com</p>
